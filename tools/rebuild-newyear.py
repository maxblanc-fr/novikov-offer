...
SERVICE_CARDS = {
    ...
    # Сомелье здесь снова оплачивается за гостя (2 700 ₽, как в винном казино) —
    ...
    "Дегустационные казино": [
        ("Цена = сомелье 2 200 ₽/гость", "Цена = сомелье 2 700 ₽/гость"),
        ("Price = sommelier 2 200 ₽/guest", "Price = sommelier 2 700 ₽/guest"),
        ('p:"1 050 ₽/гость · раунд", n:"3 раунда ≈ 64 200 ₽"',
         'p:"1 300 ₽/гость · раунд", n:"3 раунда ≈ 79 200 ₽"'),
        ('p:"1 200 ₽/гость · раунд", n:"3 раунда ≈ 69 600 ₽"',
         'p:"1 500 ₽/гость · раунд", n:"3 раунда ≈ 86 400 ₽"'),
        ("плюс работа сомелье 2 200 ₽/гость", "плюс работа сомелье 2 700 ₽/гость"),
        ("plus the sommelier at 2 200 ₽/guest", "plus the sommelier at 2 700 ₽/guest"),
        ('price:{ru:"Сомелье 2 200 ₽/гость · 3 раунда", en:"Sommelier 2 200 ₽/guest · 3 rounds"}',
         'price:{ru:"Сомелье 2 700 ₽/гость · 3 раунда", en:"Sommelier 2 700 ₽/guest · 3 rounds"}'),
    ],
...
SERVICE_TMAP = {
    ...
    '"3 раунда ≈ 64 200 ₽":"3 rounds ≈ 64 200 ₽"':     '"3 раунда ≈ 79 200 ₽":"3 rounds ≈ 79 200 ₽"',
    '"3 раунда ≈ 69 600 ₽":"3 rounds ≈ 69 600 ₽"':     '"3 раунда ≈ 86 400 ₽":"3 rounds ≈ 86 400 ₽"',
